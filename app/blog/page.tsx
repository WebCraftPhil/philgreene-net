...
export const metadata = {
  ...
  description: "Insights on AI automation, Etsy growth, and data analysis from Phil Greene.",
};
...
const blogPosts = [
  {
    ...
    excerpt: 'Learn how to design and implement AI-powered automation systems that can transform your business processes and save hours of manual work.',
  ...
  },
  {
    ...
    excerpt: 'Discover the key metrics and strategies that successful Etsy sellers use to optimize their shops and increase revenue.',
  ...
  },
  {
    ...
    excerpt: 'A systematic approach to data analysis that helps you extract meaningful insights and make data-driven decisions.',
  ...
  },
  {
    ...
    excerpt: 'Explore how businesses are using automation to streamline operations and achieve remarkable results.',
    category: 'ai-automation',
...
const categories = [
  { id: 'ai-automation', name: 'AI & Automation', count: 2, color: 'bg-purple-100 text-purple-800 dark:bg-purple-900/20 dark:text-purple-300' },
  { id: 'etsy-growth', name: 'Etsy Growth', count: 1, color: 'bg-orange-100 text-orange-800 dark:bg-orange-900/20 dark:text-orange-300' },
  { id: 'data-analysis', name: 'Data Analysis', count: 1, color: 'bg-blue-100 text-blue-800 dark:bg-blue-900/20 dark:text-blue-300' },
];
