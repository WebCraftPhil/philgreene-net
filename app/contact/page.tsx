          ...
          <div className="space-y-8">
            <div>
              ...
              <p className="text-lg text-gray-600 dark:text-gray-300 mb-8">
                ...
                data analysis, automation solutions, or full-stack development, I&apos;d love to 
            ...
            <div>
              ...
              <div className="space-y-3">
                <div className="flex items-center gap-3">
                  ...
                  <span className="text-gray-600 dark:text-gray-400">Data Analysis & Business Intelligence</span>
                </div>
                <div className="flex items-center gap-3">
                  <div className="h-2 w-2 rounded-full bg-blue-600"></div>
                  <span className="text-gray-600 dark:text-gray-400">AI Automation & Integration</span>
                </div>
                <div className="flex items-center gap-3">
                  <div className="h-2 w-2 rounded-full bg-blue-600"></div>
                ...
                <div className="flex items-center gap-3">
                  <div className="h-2 w-2 rounded-full bg-blue-600"></div>
                  <span className="text-gray-600 dark:text-gray-400">E-commerce Analytics & Optimization</span>
                </div>
              </div>
            </div>
            ...
            <div className="rounded-lg bg-green-50 p-6 dark:bg-green-900/20">
              ...
              <div className="space-y-2">
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-sm text-green-700 dark:text-green-300">Available for new projects</span>
                </div>
                <div className="flex items-center gap-2">
                  <div className="h-2 w-2 rounded-full bg-green-500"></div>
                  <span className="text-sm text-green-700 dark:text-green-300">Open to long-term collaborations</span>
                </div>
                <div className="flex items-center gap-2">
                  <div className="h-2 w-2 rounded-full bg-green-500"></div>
                  <span className="text-sm text-green-700 dark:text-green-300">Flexible engagement models</span>
                </div>
              </div>
            </div>
          </div>
